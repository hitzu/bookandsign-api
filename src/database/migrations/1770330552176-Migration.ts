...
export class Migration1770330552176 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "payments" DROP COLUMN IF EXISTS "direction"`);
        await queryRunner.query(`DROP TYPE IF EXISTS "public"."payments_direction_enum"`);
        await queryRunner.query(`ALTER TABLE "payments" DROP COLUMN IF EXISTS "related_product_name"`);
